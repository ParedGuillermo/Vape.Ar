// src/components/PetSocietyPages/Salud.jsx
...
export default function Salud() {
  ...
  useEffect(() => {
    const fetchEntradas = async () => {
      ...
      if (error) {
        console.error("Error al cargar salud:", error.message);
      } else {
        setEntradas(data);
      }
      setLoading(false);
  ...
  if (loading) return <p className="p-6 text-center">Cargando contenido de salud...</p>;
  if (entradas.length === 0) return <p className="p-6 text-center">No hay artículos sobre salud aún.</p>;
  ...
  return (
    <div className="max-w-4xl p-6 mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="prose text-gray-700 prose-green max-w-none">
