// src/components/PetSocietyPages/Eventos.jsx
...
export default function Eventos() {
  ...
  if (loading) return <p className="p-6 text-center">Cargando eventos...</p>;
  if (entradas.length === 0) return <p className="p-6 text-center">No hay eventos disponibles aún.</p>;
  ...
  return (
    <div className="max-w-4xl p-6 mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="prose text-gray-700 prose-indigo max-w-none">
      ...
      <div className="flex justify-between mt-6">
        ...
        <button
          ...
          className="px-4 py-2 text-white bg-purple-600 rounded-lg disabled:opacity-50"
